...
\begin{itemize}
\item 
	\ressubheading{Backend Developer}{Dec 2019 - Present}{Blip - Paddy Power Betfair \& FanDuel - Flutter entertainment Plc}{Porto, Portugal} %chktex 8
	\begin{itemize}
...
\item
	...
	\begin{itemize}
		\resitem{Currently at the 5th Year, completing my master thesis: \textbf{A framework for driving evolutionary architectures}}
		\resitem{\bf Principal Subjects so far: }
			\begin{itemize}
				\resitem{Languages and Web Technologies; Computation Theory; Algorithms; Discreet Mathematics, Oriented Programming Languages, Operating Systems, Databases, Software Engineering, Formal tests in software, Software architectures}
			\end{itemize}
	\end{itemize}
\vspace{2pt}
\item
