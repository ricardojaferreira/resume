...
\begin{itemize}
\item 
	\ressubheading{Backend Developer}{Aug 2021 - Present}{Hyperscience, Ltd}{New York, USA (Remote)} %chktex 8
	\begin{itemize}
		\resitem{Designing abstractions, APIs and tools to connect with Machine Learning modules;}
 		\resitem{Development of the inteligent document processing (IDP) tool, written in Python;}
