...
\hypersetup{colorlinks,breaklinks,
            linkcolor=sectcol,urlcolor=sectcol,
            anchorcolor=sectcol,citecolor=sectcol}
...
\newcommand{\princemail}{\faPaperPlane\hspace{3pt}\email{ricarraf@gmail.com}}
\newcommand{\github}{\faGithub\hspace{3pt}\href{url}{/ricardojaferreira}}
\newcommand{\linkedin}{\faLinkedin/\hspace{3pt}\href{url}{/RicardoAraujoFerreira}}
...
\begin{itemize}
\item 
	\ressubheading{Web Engineer - Fullstack Developer}{July 2018 - Present}{Jumia - Porto Tech Center}{Porto, Portugal} %chktex 8
	\begin{itemize}
	...
	\end{itemize}
\item 
	\ressubheading{Fullstack Developer}{Feb 2018 - July 2018}{7Skin, Lda (E-Commerce)}{Porto, Portugal} %chktex 8
	\begin{itemize}
...
\item
	...
	\begin{itemize}
		...
		\resitem{\bf Principal Subjects so far: }
			\begin{itemize}
				\resitem{Languages and Web Technologies; Computation Theory; Algorithms; Discreet Mathematics, Oriented Programming Languages, Operating Systems, Databases}
			\end{itemize}
	\end{itemize}
\vspace{2pt}
\item
