...
\begin{metasection}{Technologies}
	...
	\textcolor{black}{
		PlayFramework {\scriptsize \faCircle} Zend Famework {\scriptsize \faCircle} Angular {\scriptsize \faCircle} Apache {\scriptsize \faCircle} Nginx {\scriptsize \faCircle} Git {\scriptsize \faCircle} MySql / MariaDB {\scriptsize \faCircle} MongoDB {\scriptsize \faCircle} ElasticSearch {\scriptsize \faCircle} Couchbase {\scriptsize \faCircle} RabbitMQ {\scriptsize \faCircle} \LaTeX %chktex 1	
	}
\end{metasection}
...
\null %chktex 1
\vspace*{\fill}
\hspace{-0.25\linewidth}\colorbox{bgcol}{\makebox[1.5\linewidth][c]{\mystrut\small \textcolor{white}{Resume 2018 | Ricardo Ferreira :: ricarraf@gmail.com} $\cdot$ \textcolor{white}{:: 916 151 56 5}}}
